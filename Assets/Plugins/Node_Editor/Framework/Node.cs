...
namespace NodeEditorFramework
{
	public abstract class Node : ScriptableObject
	{
        ...
        protected internal virtual void DrawNode () 
		{
            ...
            GUI.backgroundColor = new Color(0.48f, 0.48f, 0.48f);
            if (this.GetType() == typeof(DialogNodeEditor.DialogStartNode) || this.GetType() == typeof(DialogNodeEditor.DialogEndNode) || this.GetType() == typeof(DialogNodeEditor.DialogJumpNode))
                GUI.backgroundColor = new Color(1.0f, 0.6f, 0.6f);
            if (this.GetType().IsSubclassOf(typeof(DialogNodeEditor.BaseSystemNode)))
                GUI.backgroundColor = new Color(1.0f, 1.0f, 0.32f);    
