...
using UnityEngine.Events;
	...
	public class ItemDataEditor : EditorWindow {
		...
		public static string databaseDir = "Assets/Plugins/ItemDataEditor/Resources/";
		...
		static void LoadDatabase(){
			...
			itemDatabaseCache = (ItemDatabase) Resources.Load("ItemDatabase", typeof(ItemDatabase));
