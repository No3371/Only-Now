...
namespace DialogNodeEditor
{
    ...
    [Node(false, "Dialog/Random Node", new Type[] { typeof(DialogTreeCanvas) })]
    public class RandomNode : BaseDialogNode
    {
        private const string Id = "randomNode";
        public override string GetID { get { return Id; } }
        public override Type GetObjectType { get { return typeof(RandomNode); } }
        ...
        {
            RandomNode node = CreateInstance<RandomNode>();
