...
namespace DialogSystem.Runtime
{
    ...
    public class OptionsBubbleController : MonoBehaviour
    {
        ...
        DialogSystem.DisplayDoneReceiver receiver;
        ...
        void Update()
        {
            ...
            if (Input.GetKeyDown(DialogSystem.instance.inputSet.Up)) PreviousSelection();
            else if (Input.GetKeyDown(DialogSystem.instance.inputSet.Down)) NextSelection();
            else if (Input.GetKeyDown(DialogSystem.instance.inputSet.Confirm)) InteractHandler();
        }
