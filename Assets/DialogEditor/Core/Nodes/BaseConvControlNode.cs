...
namespace DialogNodeEditor
{
    ...
    public abstract class BaseConvControlNode : BaseDialogNode
    {
        private const string Id = "BaseConvControlNode";
        public override string GetID { get { return Id; } }
        public override Type GetObjectType { get { return typeof(BaseConvControlNode); } }
        ...
        protected internal override void NodeGUI()
        {
            ...
            GUILayout.Label("A conversation control node.");
